...
const IzmjenaBoravkaPage = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/api/svi-boravci1/${id_boravka}`)
      .then((res) => {
        const data = res.data;
        setBoravakData(data);
      })
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              ...
              <select
                ...
                id="id_korisnika"
                name="id_korisnika"
                value={boravakData.id_korisnika}
                onChange={handleChange}
              >
          ...
          <div className="row mb-3">
            <div className="col-md-6">
              ...
              <input
                ...
                className="form-control"
                id="datum_useljenja"
                name="datum_useljenja"
                value={boravakData.datum_useljenja}
                onChange={handleChange}
              />
            </div>
            <div className="col-md-6">
              ...
              <input
                ...
                value={boravakData.datum_iseljenja}
                onChange={handleChange}
              />
            </div>
          </div>
